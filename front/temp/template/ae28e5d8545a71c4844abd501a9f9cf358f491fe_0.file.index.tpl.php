<?php
/* Smarty version 3.1.30, created on 2024-06-05 10:55:27
  from "C:\xampp\htdocs\dev23-dmcr-ab\front\controller\script\follow\template\index.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_665fe1af891245_81950179',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ae28e5d8545a71c4844abd501a9f9cf358f491fe' => 
    array (
      0 => 'C:\\xampp\\htdocs\\dev23-dmcr-ab\\front\\controller\\script\\follow\\template\\index.tpl',
      1 => 1717553665,
      2 => 'file',
    ),
  ),
...
function content_665fe1af891245_81950179 (Smarty_Internal_Template $_smarty_tpl) {
...
/home">หน้าหลัก</a></li>
                        <li class="breadcrumb-item active" aria-current="page">การติดตามการใช้ประโยชน์</li>
                    </ol>
                </nav>
            </div>
        </div>
...
/follow?m=1f" class="nav-link <?php if ($_smarty_tpl->tpl_vars['masterkey']->value == '1f') {?>active<?php }?>">
                                <div class="icon">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="<?php echo $_smarty_tpl->tpl_vars['ul']->value;?>
/follow?m=2f" class="nav-link <?php if ($_smarty_tpl->tpl_vars['masterkey']->value == '2f') {?>active<?php }?>">
                                <div class="icon">
                                    <div class="justify-content-center align-items-center row row-cols-auto">
                                        <div class="col">
                                            <div>
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="<?php echo $_smarty_tpl->tpl_vars['ul']->value;?>
/follow?m=3f" class="nav-link <?php if ($_smarty_tpl->tpl_vars['masterkey']->value == '3f') {?>active<?php }?>">
                                <div class="icon">
                                    <div class="justify-content-center align-items-center row row-cols-auto">
                                        <div class="col">
                                            <div>
...
?>
                                    <?php if ($_smarty_tpl->tpl_vars['KeyfollowList']->value < 2) {?>
									<div class="col-md-6 col-12" data-aos="fade-up">
										<a class="link link-card -vertical" title="<?php echo $_smarty_tpl->tpl_vars['valuefollowList']->value['subject'];?>
...
">
											<div class="overflow-hidden card">
												<div class="thumbnail">
													<figure class="cover">
														<img alt="<?php echo $_smarty_tpl->tpl_vars['valuefollowList']->value['subject'];?>
" src="<?php ob_start();
echo $_smarty_tpl->tpl_vars['valuefollowList']->value[1];
$_prefixVariable1=ob_get_clean();
echo fileinclude($_smarty_tpl->tpl_vars['valuefollowList']->value[6],"office",$_prefixVariable1,"link");?>
" 
                                                        data-src="<?php ob_start();
echo $_smarty_tpl->tpl_vars['valuefollowList']->value[1];
$_prefixVariable2=ob_get_clean();
echo fileinclude($_smarty_tpl->tpl_vars['valuefollowList']->value[6],"pictures",$_prefixVariable2,"link");?>
...
echo DateThai($_smarty_tpl->tpl_vars['valuefollowList']->value['credate'],'13',$_prefixVariable3,'shot');?>
</div>
														<h4 class="title"><?php echo $_smarty_tpl->tpl_vars['valuefollowList']->value['subject'];?>
</h4>
														<p class="desc"><?php echo $_smarty_tpl->tpl_vars['valuefollowList']->value['title'];?>
</p>
														<div class="action">
...
echo fileinclude($_smarty_tpl->tpl_vars['valuefollowList']->value[6],"office",$_prefixVariable4,"link");?>
" 
																data-src="<?php ob_start();
echo $_smarty_tpl->tpl_vars['valuefollowList']->value[1];
$_prefixVariable5=ob_get_clean();
echo fileinclude($_smarty_tpl->tpl_vars['valuefollowList']->value[6],"pictures",$_prefixVariable5,"link");?>
" class="img-cover lazy">
														</figure>
													</div>
													<div class="card-body">
...
echo DateThai($_smarty_tpl->tpl_vars['valuefollowList']->value['credate'],'13',$_prefixVariable6,'shot');?>
</div>
															<h4 class="title"><?php echo $_smarty_tpl->tpl_vars['valuefollowList']->value['subject'];?>
</h4>
															<p class="desc"><?php echo $_smarty_tpl->tpl_vars['valuefollowList']->value['title'];?>
