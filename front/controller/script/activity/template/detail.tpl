            ...
            <div class="attachment-list" data-aos="fade-up" data-aos-anchor="#trigger-attach" data-aos-anchor-placement="top-bottom" id="trigger-action">
               ...
               <div class="swiper attach-swiper default-swiper">
                  <div class="swiper-wrapper">
                     ...
                     <div class="swiper-slide">
                        <a title="{$valuecallfile.3}{$fileinfo.type}" class="link attach-item" target="_blank" href="{$ul}/downloadFile/{$valuecallfile.2|fileinclude:"file":$ActivityDetail.masterkey:"download"}&n={$valuecallfile.3}&id={encodeStr($valuecallfile.0)}">
                                       ...
                                       <div class="col">
                                          <div class="inner">
                                             ...
                                             <div class="desc hstack gap-3">
                                                ...
                                                <div class="type">
                                                   ขนาด : <span class="text-primary">{$valuecallfile.2|fileinclude:'file':{$ActivityDetail.masterkey}|get_IconSize}</span>
                                                </div>
                                                <div class="download">
