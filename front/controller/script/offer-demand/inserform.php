...
global $coreLanguageSQL;
		...
		$insert=array();
		$insert[$config['contact']['main']['db']."_language"] = "'".$txtLanguage."'";
		$insert[$config['contact']['main']['db']."_masterkey"] = "'".$masterkey."'";
		
		$insert[$config['contact']['main']['db']."_name"] = "'".changeQuot($_POST['inputName'])."'";
		$insert[$config['contact']['main']['db']."_address"] = "'".changeQuot($_POST['inputAddress'])."'";
		$insert[$config['contact']['main']['db']."_addressP"] = "'".$_POST['inputAddressP']."'";
		$insert[$config['contact']['main']['db']."_addressC"] = "'".$_POST['inputAddressC']."'";
		$insert[$config['contact']['main']['db']."_addressT"] = "'".$_POST['inputAddressT']."'";
		$insert[$config['contact']['main']['db']."_zipcode"] = "'".changeQuot($_POST['inputZipcode'])."'";
		$insert[$config['contact']['main']['db']."_tel"] = "'".changeQuot($_POST['inputTel'])."'";

	
		$insert[$config['contact']['main']['db']."_totle"] = "'".changeQuot($_POST['inputTotle'])."'";
		$insert[$config['contact']['main']['db']."_nameJoin"] = "'".changeQuot($_POST['inputNameJoin'])."'";
		$insert[$config['contact']['main']['db']."_addressJ"] = "'".changeQuot($_POST['inputAddressJ'])."'";
		$insert[$config['contact']['main']['db']."_officeP"] = "'".$_POST['inputOfficeP']."'";
		$insert[$config['contact']['main']['db']."_officeC"] = "'".$_POST['inputOfficeC']."'";
		$insert[$config['contact']['main']['db']."_officeT"] = "'".$_POST['inputOfficeT']."'";
		$insert[$config['contact']['main']['db']."_zipcodeJ"] = "'".changeQuot($_POST['inputZipcodeJ'])."'";
		$insert[$config['contact']['main']['db']."_telJ"] = "'".changeQuot($_POST['inputTelJ'])."'";

		$insert[$config['contact']['main']['db']."_unit"] = "'".changeQuot($_POST['inputUnit'])."'";
		$insert[$config['contact']['main']['db']."_gid"] = "'".$_POST['inputGID']."'";
		$insert[$config['contact']['main']['db']."_station"] = "'".changeQuot($_POST['inputStation'])."'";
		$insert[$config['contact']['main']['db']."_type"] = "'".changeQuot($_POST['inputType'])."'";
		$insert[$config['contact']['main']['db']."_area"] = "'".changeQuot($_POST['inputArea'])."'";
		$insert[$config['contact']['main']['db']."_money"] = "'".changeQuot($_POST['inputMoney'])."'";
		$insert[$config['contact']['main']['db']."_sea"] = "'".changeQuot($_POST['inputSea'])."'";
		$insert[$config['contact']['main']['db']."_water"] = "'".changeQuot($_POST['inputWater'])."'";
		$insert[$config['contact']['main']['db']."_w"] = "'".changeQuot($_POST['inputW'])."'";
		$insert[$config['contact']['main']['db']."_message"] = "'".changeQuot($_POST['inputMessage'])."'";
	...
	$sql_group = "SELECT ".$config['contact']['group']['db']."_subject FROM ".$config['contact']['group']['db']." WHERE ".$config['contact']['group']['db']."_id='".$inputGID."' ";
	...
	$sql = "SELECT ".$config['contact']['email']['db']."_email FROM ".$config['contact']['email']['db']." WHERE ".$config['contact']['email']['db']."_gid='".$inputGID."' ";
	$Query=wewebQueryDB($coreLanguageSQL,$sql);
