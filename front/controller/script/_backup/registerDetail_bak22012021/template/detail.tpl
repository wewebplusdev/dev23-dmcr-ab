    ...
    <div class="default-page">
        ...
        <div class="container">
            <div class="default-wrapper" style="display:none;">
                <div class="default-title">ระบบลงทะเบียนออนไลน์</div>
                            ...
                            <input name="inputQuest[{$listQuseList.id}]" id="inputQuest-{$listQuseList.id}" type="hidden" value="{$listQuseList.id}">
                                ...
                                <div class="upload-file">
                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <div class="upload-file-btn form-form-att">
                                                         <input type="file" name="inputFileUpload-{$listQuseList.id}" id="inputFileUpload-{$listQuseList.id}" onchange="ajaxFileUploadDoc({$myid},{$listQuseList.id});" size="50" value="" {if $listQuseList.request eq 1} data-error="{$listQuseList.request_title}" required {/if}>
                                                        <div class="btn btn-file">เลือกไฟล์..</div>
                                        ...
                                        <div class="help-block">เฉพาะไฟล์ PDF, PNG, JPG  ขนาด 10MB</div>
                                    </div>
                                </div>
                                {/if}
                            {/foreach}
