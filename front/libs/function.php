...
function fileinclude($filename, $fileType = 'html', $mod_tb_about_masterkey = null, $for = 'check', $crop = false, $cropthumb = false) {
...
function callBDay($date,$month,$year,$type = "shot",$fun=null) {
...
############################################
		...
		$query_pic=$db->execute($sql_pic);
		$row_pic=$query_pic->fetchRow();
