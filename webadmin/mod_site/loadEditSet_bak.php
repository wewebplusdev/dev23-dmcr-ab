...
// ############################## Add other faction ##################################
                ...
                function addfaction() {
                  ...
                  var inputfac = '<td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["info:faction"] ?><span class="fontContantAlert"></span></td>';
                  ...
                  var inputfactel = '<td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["info:factiontel"] ?><span class="fontContantAlert"></span></td>';
                  ...
                  var inputfacemail = '<td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["info:email"] ?><span class="fontContantAlert"></span></td>';
                  var inputfacemailtxt = '<td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >    <input class="formInputContantTb"  name="inputfaction[email][]" id="inputfactionemail"  value="<?= $ValFac['email'] ?>"/><br /></td>';
        ...
        <form action="?" method="get" name="myForm" id="myForm">
            ...
            <div class="divRightMain" >
                ...
                <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
                    ...
                    <tr >
                        <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["ab:subject"] ?> (TH) <span class="fontContantAlert">*</span></td>
                    ...
                    <!-- <tr >
                        <td align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["ab:subject"] ?> (EN) <span class="fontContantAlert">*</span></td>
                        <td colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                            <input name="inputSubjectEn" id="inputSubjectEn" type="text"  class="formInputContantTb" value="<?= $valSubjectEN ?>"/>   </td>
                    </tr> -->

                    <tr >
                        <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["ab:office"] ?> (TH) <span class="fontContantAlert">*</span></td>
                    ...
                    <!-- <tr >
                        <td align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["ab:office"] ?> (EN) <span class="fontContantAlert">*</span></td>
                        <td colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                            <input name="inputOfficeEN" id="inputOfficeEN" type="text"  class="formInputContantTb" value="<?= $valSubjectOfficeEn ?>"/>   </td>
                    </tr> -->

                    <!--
                      <tr style="display:none;" >
                          <td align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["ab:titleEn"] ?><span class="fontContantAlert"></span></td>
                          <td colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                              <textarea name="inputTitleEn" id="inputTitleEn" cols="45" rows="5" class="formTextareaContantTb"><?= $valTitleEn ?></textarea>     </td>
                      </tr>
                    -->
                ...
                <!-- <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
                    <tr >
                        <td colspan="7" align="left"  valign="middle" class="formTileTxt tbBoxViewBorderBottom">
                            <span class="formFontSubjectTxt"><?= $langMod["txt:slogan"] ?></span><br/>
                            <span class="formFontTileTxt"><?= $langMod["txt:sloganDe"] ?></span>                             </td>
                    </tr>
                    <tr >
                        <td colspan="7" align="right"  valign="top"   height="15" ></td>
                    </tr>
                ...
                <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder">
                    ...
                    <tr >
                        <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["inp:seotitle"] ?> (TH)<span class="fontContantAlert">*</span></td>
                        ...
                        <tr >
                        <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["inp:seodes"] ?> (TH)<span class="fontContantAlert">*</span></td>
                     ...
                     <tr >
                        <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["inp:seokey"] ?> (TH)<span class="fontContantAlert">*</span></td>
                ...
                <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder">
                    ...
                    <tr >
                        <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?=$langMod["set:open"]?><span class="fontContantAlert">*</span></td>
                        <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                            <input class="formInputContantTb"  name="info[open]"  id="infoOpen"  value="<?= $ValConfig['open'] ?>"/><br />
                            <span class="formFontNoteTxt"><?= $langMod["info:telde"] ?></span></td>
                    </tr>

                    <tr >
                        <td width="18%" align="right"  valign="top"  class="formLeftContantTb" >
                            <?= $langMod['info:address']; ?> (TH)
                    ...
                    <tr >
                        ...
                        <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                            <input class="formInputContantTb"  name="info[tel]"  id="infoTel"  value="<?= $ValConfig['tel'] ?>"/><br />
                            <span class="formFontNoteTxt"><?= $langMod["info:telde"] ?></span></td>
                    </tr>
                    ...
                    <tr >
                        ...
                        <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                            <input class="formInputContantTb"  name="info[fax]" id="infoFax" value="<?= $ValConfig['fax'] ?>"/>  <br />
                    ...
                    <tr >
                        ...
                        <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                            <input class="formInputContantTb"  name="info[email]" id="infoEmail" value="<?= $ValConfig['email'] ?>"/>  <br />
                    ...
                    <tr >
                        ...
                        <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                            <input class="formInputContantTb"  name="info[hotline]" id="hotline"  value="<?= $ValConfig['hotline'] ?>"/><br />
                            <span class="formFontNoteTxt"><?= $langMod["info:hotlinede"] ?></span></td>
                    </tr>
<!-- start faction -->
                    <td align="right"  valign="top" width="100%"  colspan="6" >
                      <?php if (!empty($ValFac)) {
                        ...
                        <tr id="fac<?=$key?>">
                            <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["info:faction"] ?><span class="fontContantAlert"></span></td>
                            <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                                <input class="formInputContantTb"  name="inputfaction[name][]" id="inputfaction"  value="<?= $value['name'] ?>"/><br /></td>
                            <td width="10%" align="left">
                              <?php if ($key<1){ ?>
                                <div class="btnAdd3" style="padding-right: 86px; padding-top: 20px;" title="??" onclick="addfaction();"></div>
                              <?php }else { ?>
                                <div class="btnDel2" onclick="removefac(<?=$key?>)" title="" style="padding-right: 50px; padding-top: 20px;"  ></div>
                              <?php } ?>
                            </td>
                        </tr>
                        <tr id="factel<?=$key?>">

                            <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["info:factiontel"] ?><span class="fontContantAlert"></span></td>
                            <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                                <input class="formInputContantTb"  name="inputfaction[tel][]" id="inputfactionTel"  value="<?= $value['tel'] ?>"/><br />
                            <!-- <span class="formFontNoteTxt"><?= $langMod["info:telde"] ?></span> -->
                          </td>
                        </tr>
                        <tr id="facemail<?=$key?>">
                            ...
                            <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["info:email"] ?><span class="fontContantAlert"></span></td>
                            <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                                <input class="formInputContantTb"  name="inputfaction[email][]" id="inputfactionemail"  value="<?= $value['email'] ?>"/><br />
                            </td>
                        </tr>
...
<!-- end faction -->
                    ...
                    <tr >
                        ...
                        <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                            ...
                            <?= $langMod['info:latiture'] ?> : <input name="info[glati]" id="glati" value="<?= $ValConfig['glati'] ?>"/>
                            <?= $langMod['info:longtiture'] ?>  : <input name="info[glongti]" id="glongti" value="<?= $ValConfig['glongti'] ?>"/>
                            <br/>
                    ...
                    <tr >
                        ...
                        <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                            ...
                            <div id="boxPicNew" class="formFontTileTxt">
                                <? if (is_file($valPic)) { ?>
                                    <img src="<?= $valPic ?>"  style="float:left;border:#c8c7cc solid 1px;"  />
                    ...
                    <tr style="display:none;">
                       <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["info:pichotline"] ?></td>
                       <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                           <div class="file-input-wrapper">
                               <button class="btn-file-input"><?= $langTxt["us:inputpicselect"] ?></button>
                           ...
                           <div id="boxPicHT" class="formFontTileTxt">
                               <? if (is_file($valHotline)) { ?>
                                   <img src="<?= $valHotline ?>"  style="float:left;border:#c8c7cc solid 1px;"  />
                                   ...
                                   <input type="hidden" name="picHT" id="picHT" value="<?= $valHotlineName ?>" />
                               <? } ?>
                           </div>
                   ...
                   <tr style="display:none;">
                      <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["info:pichotlineH"] ?></td>
                      <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                          <div class="file-input-wrapper">
                              <button class="btn-file-input"><?= $langTxt["us:inputpicselect"] ?></button>
                          ...
                          <div id="boxPicHTh" class="formFontTileTxt">
                              <? if (is_file($valHotlineH)) { ?>
                                  <img src="<?= $valHotlineH ?>"  style="float:left;border:#c8c7cc solid 1px;"  />
                                  ...
                                  <input type="hidden" name="picHTh" id="picHTh" value="<?= $valHotlineNameH ?>" />
                              <? } ?>
                          </div>
                ...
                <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder " style="display:none;">
                    <tr >
                        <td colspan="7" align="left"  valign="middle" class="formTileTxt tbBoxViewBorderBottom">
                            <span class="formFontSubjectTxt"><?= $langMod["txt:setOffice"] ?></span><br/>
                            <span class="formFontTileTxt"><?= $langMod["txt:setOfficeDe"] ?></span>                             </td>
                    </tr>
                    <tr >
                        <td colspan="7" align="right"  valign="top"   height="15" ></td>
                    </tr>
                    ...
                    <tr >
                        <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["txt:subjectOffice"] ?> <span class="fontContantAlert"></span></td>
                        <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><input name="inputSubjectOffice" id="inputSubjectOffice" type="text"  class="formInputContantTb" value="<?= $valSubjectOffice ?>"/></td>
                    </tr>

                    <tr >
                        <td align="right"  valign="top"  class="formLeftContantTb" ><?= $langMod["txt:titleOffice"] ?>  <span class="fontContantAlert"></span></td>
                        <td colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                            <input name="inputTitleOffice" id="inputTitleOffice" type="text"  class="formInputContantTb" value="<?= $valTitleOffice ?>"/>   </td>
                    </tr>
