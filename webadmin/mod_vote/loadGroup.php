                    ...
                    <form action="?" method="post" name="myForm" id="myForm">
                                                ...
                                                <td align="right">
                                                    <? if ($valPermission == "RW") { ?>
                                                        <div  class="btnAdd" title="<?= $langTxt["btn:add"] ?>" onclick="document.myFormHome.inputLt.value = 'Thai';
                                                                    addContactNew('addGroup.php');"></div>
                        ...
                        <div class="divRightMain" >
                            ...
                            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center"   class="tbBoxListwBorder">
                                ...
                                <?
// SQL SELECT #########################
                                $sql = "SELECT " . $mod_tb_root_group . "_id," . $mod_tb_root_group . "_name," . $mod_tb_root_group . "_lastdate," . $mod_tb_root_group . "_status," . $mod_tb_root_group . "_nameen  FROM " . $mod_tb_root_group;
                                $sql = $sql . "  WHERE " . $mod_tb_root_group . "_masterkey ='" . $_REQUEST['masterkey'] . "'   ";

                                if ($inputSearch <> "") {
                                    $sql = $sql . "  AND  (
		" . $mod_tb_root_group . "_name LIKE '%$inputSearch%'  OR
		" . $mod_tb_root_group . "_nameen LIKE '%$inputSearch%'   ) ";
                                }
