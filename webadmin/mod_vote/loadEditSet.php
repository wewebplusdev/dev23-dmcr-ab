                        ...
                        <td  class="divRightNavTb" align="right">
                            ...
                            <div class="divRightHead">
                                <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center" >
                                  <tr>
                                    <td height="77" align="left"><span class="fontHeadRight"><?=$langMod["txt:titleedits"]?></span></td>
                                    <td align="left">
...
?>
  <tr >
	...
	<a href="javascript:void(0)"  onclick="document.myForm.valDelFile.value=<?=$valEmailID?>; modDelEmail('deleteEmail.php')" ><img src="../img/btn/delete.png" align="absmiddle" title="Delete email"  hspace="5"     border="0" /></a> <?=$valEmailNew?></div></td>
  </tr>
...
<? }}?>
  ...
  <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" style="padding-top:10px;" ><?=$langMod["tit:emailset"]?>:<span class="fontContantAlert"></span></td>
