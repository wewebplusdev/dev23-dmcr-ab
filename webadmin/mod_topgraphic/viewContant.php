...
$valLinkNav1="../core/index.php";
   ...
   $sql = "SELECT   ";
        $sql .= "   ".$mod_tb_root."_id , ".$mod_tb_root."_credate , ".$mod_tb_root."_crebyid, ".$mod_tb_root."_status,    ".$mod_tb_root."_sdate      ,    ".$mod_tb_root."_edate    , ".$mod_tb_root."_lastdate, ".$mod_tb_root."_subject , ".$mod_tb_root."_lastbyid,    ".$mod_tb_root."_target,    ".$mod_tb_root."_pic , ".$mod_tb_root."_url      ";

      }elseif($_REQUEST['inputLt']=="Eng"){

      $sql = "SELECT   ";
        $sql .= "   ".$mod_tb_root."_id , ".$mod_tb_root."_credate , ".$mod_tb_root."_crebyid, ".$mod_tb_root."_status,    ".$mod_tb_root."_sdate      ,    ".$mod_tb_root."_edate    , ".$mod_tb_root."_lastdate, ".$mod_tb_root."_subjecten , ".$mod_tb_root."_lastbyid,    ".$mod_tb_root."_target,    ".$mod_tb_root."_picen , ".$mod_tb_root."_urlen      ";
      }
...
<form action="?" method="get" name="myForm" id="myForm">
   ...
   <br />
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valUrl?></div></td>
  </tr>
   <tr >
