...
$valLinkNav1="../core/index.php";
      ...
      $sql = "SELECT  ";
        $sql .= "  ".$mod_tb_root."_id, ".$mod_tb_root."_lastdate, ".$mod_tb_root."_creby, ".$mod_tb_root."_status ,    ".$mod_tb_root."_subject    ,    ".$mod_tb_root."_sdate,    ".$mod_tb_root."_edate,    ".$mod_tb_root."_target,    ".$mod_tb_root."_pic , ".$mod_tb_root."_url  ";
      }elseif($_REQUEST['inputLt']=="Eng"){

      $sql = "SELECT  ";
        $sql .= "  ".$mod_tb_root."_id, ".$mod_tb_root."_lastdate, ".$mod_tb_root."_creby, ".$mod_tb_root."_status ,    ".$mod_tb_root."_subjecten    ,    ".$mod_tb_root."_sdate,    ".$mod_tb_root."_edate,    ".$mod_tb_root."_target,    ".$mod_tb_root."_picen , ".$mod_tb_root."_urlen  ";
      }
