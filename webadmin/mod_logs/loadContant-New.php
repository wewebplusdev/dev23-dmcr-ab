...
// Check to set default value #########################
    ...
    <td align="left"  width="31%" style="padding-right:10px;" >
       <input name="sdateInput" type="text"  id="sdateInput"  placeholder="<?=$langMod["tit:sSedate"]?>" value="<?=trim($_REQUEST['sdateInputSe'])?>" class="formInputSearchI" style="width:98%;"/>
       </td>
    <td align="left"  width="31%" style="padding-right:10px;" >
      <input name="edateInput" type="text"  id="edateInput"  placeholder="<?=$langMod["tit:eSedate"]?>" value="<?=trim($_REQUEST['edateInputSe'])?>" class="formInputSearchI"  style="width:98%;"/>
    </td>
    <td   id="boxSelectTest" width="31%">
  <input name="inputSearch" type="text"  id="inputSearch" placeholder="<?=$langMod["tit:sSearch"]?>" value="<?=trim($_REQUEST['inputSearch'])?>" class="formInputSearchI"/></td>
          <td style="padding-right:10px;" width="5%" align="right"><input name="searchOk" id="searchOk" onClick="document.myForm.submit();"  type="button" class="btnSearch"  value=" "  /></td>
                        ...
                        <div class="divRightMain" >
                            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center"   class="tbBoxListwBorder">
                                <tr ><td align="left"   valign="middle"  class="divRightTitleTbL" style="height:30px; padding-left:5px;" ><span class="fontTitlTbRight"><?=$langTxt["mg:subject"]?></span></td>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="padding-top:3px; padding-left:5px;" >
                                                          ...
                                                          <a  href="javascript:void(0)"  onclick="
                                                                ...
                                                                viewContactNew('viewContant.php');" ><?= $valSubject ?></a></div></td>
                                                    </tr>
                                                </table></td>
