     ...
     <div class="mainBackOffice">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
                ...
                <input name="sdateInputSe" type="hidden" id="sdateInputSe" value="<?=$_REQUEST['sdateInput']?>" />
                <input name="edateInputSe" type="hidden" id="edateInputSe" value="<?=$_REQUEST['edateInput']?>" />
                </form>
