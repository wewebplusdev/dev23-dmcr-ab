                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top:20px;" align="center">
                        ...
                        <div class="divRightMain" >
                            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center"   class="tbBoxListwBorder">
                                <tr ><td align="left"   valign="middle"  class="divRightTitleTbL" style="height:30px; padding-left:10px;" ><span class="fontTitlTbRight"><?=$langTxt["mg:subject"]?></span></td>
                                    ...
                                    while ($index < $count_record + 1) {
                                        ...
                                        <tr class="<?= $valDivTr ?>" >
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td align="left" style="padding-top:3px; padding-left:10px;" >
                                                           <div class="widthDiv">
                                                         <span class="fontContantTbupdate"><?= $valSubject ?></span></div></td>
                                                    </tr>
                                                </table></td>
                                            ...
                                            <td  class="divRightContantOverTb"  valign="top"  align="center">
                                                    ...
                                                    <span class="fontContantTbupdate"><?= $valStatus ?></span>                                                                                        </td>
