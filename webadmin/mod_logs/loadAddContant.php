                        ...
                        <td  class="divRightNavTb" align="right">
                            ...
                            <div class="divRightHead">
                                <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center" >
                                  <tr>
                                    <td height="77" align="left"><span class="fontHeadRight"><?=$langMod["txt:titleadd"]?><? if($_SESSION[$valSiteManage.'core_session_languageT']==2){?>(<?=$langTxt["lg:thai"]?>)<? }?></span></td>
                                    <td align="left">
...
<script type="text/javascript" language="javascript">
	...
	function ajaxFileUploadMap(){
		...
		jQuery.ajaxFileUpload({
				url:'loadInsertPicMap.php?myID=<?=$myRand?>&masterkey=<?=$_REQUEST['masterkey']?>&langt=<?=$_REQUEST['inputLt']?>&delpicname='+valuepicname+'&menuid=<?=$_REQUEST['menukeyid']?>',
				secureuri:false,
