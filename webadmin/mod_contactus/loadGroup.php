...
<input name="include" type="hidden" id="module_orderby" value="<?= $_REQUEST['include'] ?>" />
					...
					<div class="divRightNav">
                        ...
                        <td  class="divRightNavTb" align="left"><span class="fontContantTbNav">
                                  <? if (!empty($_REQUEST['include'])) { } else { ?>  <a href="<?=$valLinkNav1?>" target="_self"><?=$valNav1?></a> <? } ?>
                                <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?=$valNav2?></span></td>
                        ...
                        <? if (!empty($_REQUEST['include'])) { } else { ?> <div class="menuSubMod">
...
if($count_record>0) {
  ...
  <tr>
   ...
   document.myFormHome.valEditID.value=<?=$valID?>;
    viewContactNew('viewGroup.php');" ><?=$valName?></a></td>
  </tr>
</table></td>
<? if($_SESSION[$valSiteManage.'core_session_languageT']==2){?>
  ...
  <tr>
   ...
   document.myFormHome.valEditID.value=<?=$valID?>;
    viewContactNew('viewGroup.php');" ><?=$valNameEn?></a></td>
  </tr>
</table>    </td>
<? }?>
