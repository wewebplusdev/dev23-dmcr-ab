...
<input name="sdateInputSe" type="hidden" id="sdateInputSe" value="<?=$_REQUEST['sdateInputSe']?>" />
<input name="edateInputSe" type="hidden" id="edateInputSe" value="<?=$_REQUEST['edateInputSe']?>" />
					...
					<!-- <tr>
						...
						<td class="textSearch12">
							<input name="sdateInputH" type="text"  id="sdateInputH"  placeholder="<?= $langMod["tit:sSedate"] ?>" value="<?= trim($_REQUEST['sdateInputSe']) ?>" class="formInputSearchStyle sdateInputSe" style="width: 98%;"/>
						</td>
						<td  class="textSearch2">
							<input name="edateInputH" type="text"  id="edateInputH"  placeholder="<?= $langMod["tit:eSedate"] ?>" value="<?= trim($_REQUEST['edateInputSe']) ?>" class="formInputSearchStyle edateInputSe"/>    
						</td>
					</tr> -->
    <tr>
...
if($count_record>0) {
  ...
  <tr>
   ...
   document.myFormHome.valEditID.value=<?=$valID?>;
    viewContactNew('viewContant.php');" ><?=$valName?></a><br />
	<span class="fontContantTbTime">
			<!-- <?=$langMod["tit:email"]?>: <?=$valEmail?><br /> -->
			<?=$langMod["tit:tel"]?>: <?=$valTel?></span>
	</td>
  </tr>
</table></td>
