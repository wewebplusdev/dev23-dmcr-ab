...
<input name="module_orderby" type="hidden" id="module_orderby" value="<?=$module_orderby?>" />
  ...
  <tr>
  	<td><select name="inputUT"  id="inputUT"class="formSelectSearch" onchange="document.myForm.submit(); ">
  ...
  <td><select name="inputGh"  id="inputGh"class="formSelectSearch" onchange="document.myForm.submit(); ">
                                  ...
                                  <tr>
                                    ...
                                    <td align="left">
                                            <table  border="0" cellspacing="0" cellpadding="0" align="right">
                                                <tr>
                                                    <td align="right">
                                                        <div  class="btnAdd" title="<?=$langTxt["btn:add"]?>" onclick="addContactNew('../core/addUs.php');"></div>
...
<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
  ...
  <? 
// Value SQL SELECT #########################
$sqlSelect = "".$core_tb_staff."_id,".$core_tb_staff."_fnamethai,".$core_tb_staff."_lnamethai,".$core_tb_staff."_credate ,".$core_tb_staff."_status,".$core_tb_staff."_picture,".$core_tb_staff."_usertype ,".$core_tb_staff."_username,".$core_tb_staff."_groupid";
...
if($count_record>0) {
  ...
  <tr>
   ...
   document.myFormHome.valEditID.value=<?=$valID?>;  
    viewContactNew('../core/viewUs.php');" ><?=$valName?></a></td>
  </tr>
</table>
