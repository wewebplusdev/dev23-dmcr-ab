...
$valNav2=$langTxt["nav:userManage2"];
	 	...
	 	$sql = "SELECT ".$core_tb_staff."_id , ".$core_tb_staff."_picture , ".$core_tb_staff."_groupid , ".$core_tb_staff."_username , ".$core_tb_staff."_prefix , ".$core_tb_staff."_gender , ".$core_tb_staff."_fnamethai , ".$core_tb_staff."_lnamethai , ".$core_tb_staff."_fnameeng , ".$core_tb_staff."_lnameeng , ".$core_tb_staff."_email , ".$core_tb_staff."_address , ".$core_tb_staff."_telephone , ".$core_tb_staff."_mobile , ".$core_tb_staff."_other , ".$core_tb_staff."_password, 
    ".$core_tb_staff."_usertype  FROM ".$core_tb_staff." WHERE ".$core_tb_staff."_id='".$_POST["valEditID"]."'";
...
function loadCheckUser() {
  with(document.myForm) {
    ...
    console.log(inputValueTypeUser);
...
<form action="?" method="get" name="myForm" id="myForm">
    ...
    <input name="inputTypeUser" id="inputTypeUser" type="hidden" class="formRadioContantTb" value="<?=$valUsertype?>" />
    
					<div class="divRightNav">
                        <table width="96%" border="0" cellspacing="0" cellpadding="0"  align="center" >
                        <tr>
                        <td  class="divRightNavTb" align="left"  id="defTop" ><span class="fontContantTbNav"><a href="<?=$valLinkNav1?>" target="_self"><?=$valNav1?></a>  <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?=$langTxt["us:editpermis"]?></span></td>
