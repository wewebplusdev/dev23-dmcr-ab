                            ...
                            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
                                ...
                                <tr >
                                    ...
                                    <td colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                                        <input name="inputTitle" id="inputTitle" type="text"  class="formInputContantTb" value="<?= $valTitle ?>"/>   </td>
                                </tr>
                                <tr >
                                    <td align="right"  valign="top"  class="formLeftContantTb" ><?= $langTxt["ab:titleback"] ?><span class="fontContantAlert">*</span></td>
                                    <td colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                                        <input name="inputTitleB" id="inputTitleB" type="text"  class="formInputContantTb" value="<?= $valTitleB ?>"/>   </td>
                                </tr>
