...
$valLinkNav1="../core/index.php";
      ...
      ".$mod_tb_root."_gid   ";
			...
			$sql .= " , ".$mod_tb_root."_picshow, ".$mod_tb_root."_cid, ".$mod_tb_root."_votetus,".$mod_tb_root."_year ,".$mod_tb_root."_groupProoject FROM ".$mod_tb_root." WHERE ".$mod_tb_root."_masterkey='".$_REQUEST["masterkey"]."'  AND  ".$mod_tb_root."_id='".$_REQUEST['valEditID']."' ";
...
<form action="?" method="get" name="myForm" id="myForm">
  ...
  <tr>
      ...
      <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?=  loadProvinceMember($valproid) ?></div></td>
    </tr>

    <tr>
      <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?=$langMod["tit:year"]?><span class="fontContantAlert">*</span></td>
      <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?= ($valcmsyear+243) ?></div></td>
    </tr>
