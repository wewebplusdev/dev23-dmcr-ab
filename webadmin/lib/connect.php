...
// if ($_SESSION[$valSiteManage."core_session_typemini"] == 1) {
//     $sql = "SELECT 
//  ".$core_tb_minisite."_id,
//  ".$core_tb_minisite."_urlminisite
//  FROM ".$core_tb_minisite." WHERE ".$core_tb_minisite."_memid='".$_SESSION[$valSiteManage."core_session_id"]."' ";
// $Query=wewebQueryDB($coreLanguageSQL,$sql);
// $RecordCount=wewebNumRowsDB($coreLanguageSQL,$Query);
// $Row=wewebFetchArrayDB($coreLanguageSQL,$Query);
// $_SESSION[$valSiteManage."core_session_nameminisite"] = $Row[1];
// }
